...
import i18n from "@/i18nConfig";
    ...
    ar: {
        translation: {
                "Units": "الوحدة القياسيه",
                "Edit Unit": "تعديل الوحدة القياسيه",
                "ID": "الرقم التعريفي",
                "Name": "الاسم",
...
export default function Create({ auth, unit }) {
  const { t } = useTranslation();


  const { data, setData, post, errors, reset } = useForm({
    name: unit.name || "",
    is_active: unit.is_active !== undefined ? unit.is_active : "",
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    post(route("unit.update", unit.id));
  };
