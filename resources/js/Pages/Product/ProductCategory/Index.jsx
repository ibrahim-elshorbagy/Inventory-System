...
import { useState, useEffect } from "react";
    ...
    ar: {
        translation: {
                ...
                "No categories available": "لا يوجد الاصناف متاحة",
                'Active': 'نشط',
                "Inactive":'غير نشط',
        },
    },
...
export default function Index({ auth,site_settings, categories, queryParams = null, success,danger }) {
        ...
        <div className="px-4 py-2 mb-4 text-white bg-red-600 rounded">
          ...
          <div className="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
            <div className="p-2 text-gray-900 dark:text-gray-100">
              <div className="overflow-auto">
                <table className="w-full text-sm text-left text-gray-500 rtl:text-right dark:text-gray-400">
                  ...
                  <thead className="text-xs text-gray-700 uppercase border-b-2 border-gray-500 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <tbody>
                        {categories && categories.data.length > 0 ? ( categories.data.map((category,index) => (
                        <tr
                            className={`${
              ...
              {categories && <Pagination links={categories.meta.links} />}
            </div>
          </div>
        </div>
      </div>
